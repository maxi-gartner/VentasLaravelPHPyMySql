...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="images/logo.jpg" alt="GSI Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Sistema Arya</span>
    </a>

    <!-- Sidebar  SEARCH FORM -->
    <div class="sidebar">
    <div class="sidebar-form mt-3">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <p>Resumen Ejecutivo <i class="right fas fa-angle-left"></i></p>
            </a>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <p>Gestión de Stock <i class="right fas fa-angle-left"></i></p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="#" class="nav-link active">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Configuración de Impuestos</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link">
              ...
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Respaldos y Restauración</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Integraciones (API, ERP, etc.)</p>
                </a>
              </li>
            </ul>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <p>Soporte y Ayuda <i class="right fas fa-angle-left"></i></p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="#" class="nav-link active">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Mensajes Internos</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Acceso Rápido a Funciones Frecuentes</p>
                </a>
              </li>
            </ul>
          </li>
  ...
  <footer class="main-footer">
    ...
    Desarrollador Gartner Maximiliano Ezequiel
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2024-2030 <a href="https://adminlte.io">GSI Sistema Arya (Administración Rápida y Ágil)</a></strong> Todos los derechos reservados
  </footer>
</div>
<!-- ./wrapper -->
